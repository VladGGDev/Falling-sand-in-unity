...
static class ParticleObjectDefaults
{
	...
	static void CreateWaterParticle()
	{
		...
		asset.moveChecks = new ParticleMoveChecks[8]
		{
			...
			new ParticleMoveChecks(ParticleMoveChecks.MoveDirection.TowardsHorizontalVelocity, 0.739f, true),
			new ParticleMoveChecks(ParticleMoveChecks.MoveDirection.RandomHorizontal, 1f),
	...
	static void CreateGasParticle()
	{
		...
		asset.moveChecks = new ParticleMoveChecks[8]
		{
			...
			new ParticleMoveChecks(ParticleMoveChecks.MoveDirection.TowardsHorizontalVelocity, 1f, true),
			new ParticleMoveChecks(ParticleMoveChecks.MoveDirection.RandomHorizontal, 1f),
			new ParticleMoveChecks(ParticleMoveChecks.MoveDirection.Right, 1f),
